...
class ACNet(object):
    def __init__(self, scope, sess, state_size, n_actions, stack=False, img_input=False, actor_lr=0.0001,
                 critic_lr=0.001, action_bound=None, batch_size=32, net_architecture=None):
        self.sess = sess
        ...
        self.graph_actor_lr = tf.placeholder(tf.float32, shape=(), name="learing_rate")
        self.graph_critic_lr = tf.placeholder(tf.float32, shape=(), name="learing_rate")

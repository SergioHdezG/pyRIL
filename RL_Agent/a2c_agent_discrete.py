...
from RL_Agent.base.utils.networks.agent_networks import A2CNetDiscrete
...
class Agent(A2CSuper):
    def __init__(self, actor_lr=1e-4, critic_lr=1e-3, batch_size=32, epsilon=1.0, epsilon_decay=0.9999, epsilon_min=0.1,
                 ...
                 loss_entropy_beta=0.001, tensorboard_dir=None, net_architecture=None,
    ...
    def _build_model(self, net_architecture, last_activation):
        ...
        if isinstance(actor_net, RLNetModel):
            ...
            agent_model = A2CNetDiscrete(actor_net=actor_net, critic_net=critic_model, tensorboard_dir=self.tensorboard_dir)

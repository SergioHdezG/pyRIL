if __name__ == '__main__':
    ...
    from environments.habitat_envs import HM3DRLEnv, HM3DRLVecEnv
    ...
    agent = ppo_agent_discrete_parallel_habitat.Agent(actor_lr=float(config["actor_lr"]),
                                                      ...
                                                      # TODO: [Sergio] Revisar y automaticar el control del state_size
                                                      #  cuando is_habitat=True
